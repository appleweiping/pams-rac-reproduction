...
visibly pending. Every C11 exclusion-register artifact is forbidden.
...
pinned ARIS verifier is executed under `assurance=submission`. A required
cross-family review must be healthy and traced for an accepted submission
status; otherwise the outcome remains provisional or blocked.
